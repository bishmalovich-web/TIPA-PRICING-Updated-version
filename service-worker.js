const CACHE_NAME='tipa-pricing-pwa-password-forced-tipa2026-v10';
const ASSETS=['./index.html?v=pwa-password-forced-tipa2026-v10','./manifest.json','./icon-192.png','./icon-512.png'];
